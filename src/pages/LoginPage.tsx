    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 flex items-center justify-center px-4 transition-colors duration-200">
      <div className="max-w-md w-full">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 transition-colors duration-200">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-3 border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 outline-none transition-colors duration-200"
          ...
          <div className="mt-6 pt-6 border-t border-gray-200 dark:border-gray-700">
            <button
              ...
              className="w-full text-gray-600 dark:text-gray-400 hover:text-gray-800 dark:hover:text-gray-200 font-medium"
            >
              ← Kembali ke Beranda
            </button>
          </div>
        ...
        <p className="text-center text-sm text-gray-600 dark:text-gray-400 mt-6">
          Akun hanya digunakan oleh warga Desa Nambo Udik untuk menyampaikan
          laporan resmi.
        </p>
      </div>
    </div>
